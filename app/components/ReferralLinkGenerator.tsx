    ...
    const generateReferralLink = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const mockLink = `${window.location.origin}/signup?ref=${userId}`
                setReferralLink(mockLink)
                setReferralUrl(mockLink)
            }
        } catch (error) {
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a
                            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Join me on Plutus - the best crypto flash platform!')}&url=${encodeURIComponent(referralUrl)}`}
                            target="_blank"
                        ...
                        <a
                            href={`https://wa.me/?text=${encodeURIComponent('Join me on Plutus! ' + referralUrl)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <a
                            href={`https://t.me/share/url?url=${encodeURIComponent(referralUrl)}&text=${encodeURIComponent('Join me on Plutus!')}`}
                            target="_blank"
                            rel="noopener noreferrer"
